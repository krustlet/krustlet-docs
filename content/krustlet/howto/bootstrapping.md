...
```console
$ bash <(curl https://raw.githubusercontent.com/krustlet/krustlet/master/docs/howto/assets/bootstrap.sh)
```

OR

```powershell
(Invoke-WebRequest -UseBasicParsing https://raw.githubusercontent.com/krustlet/krustlet/master/docs/howto/assets/bootstrap.ps1).Content | Invoke-Expression
```
